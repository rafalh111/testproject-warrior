...
function Movement:update(player, dt)
    ...
    if love.keyboard.isDown(RightKey) then vx = vx + 1; player.anim = player.animations.right; isMoving = true end
    if love.keyboard.isDown(LeftKey) then vx = vx - 1; player.anim = player.animations.left; isMoving = true end
    if love.keyboard.isDown(UpKey) then vy = vy - 1; player.anim = player.animations.up; isMoving = true end
    if love.keyboard.isDown(DownKey) then vy = vy + 1; player.anim = player.animations.down; isMoving = true end
